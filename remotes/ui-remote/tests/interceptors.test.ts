...
vi.mock('axios', () => import('../__mocks__/axios.ts'))
...
describe('Axios interceptors', () => {
  ...
  it('should add Authorization header to requests', async () => {
    ...
    const { requestInterceptor } = await import('../src/services/intercepteur')
  ...
  it('should refresh token on 401 response', async () => {
    ...
    const { refreshInterceptor } = await import('../src/services/intercepteur')
